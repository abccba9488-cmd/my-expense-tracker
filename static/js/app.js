...
// (shorter-term MA wins if near more than one), colour-coded red/yellow/
// green. MA240 is asymmetric on purpose — treated as a long-term value
// line rather than a support/resistance test: ANY price below it counts
// (however far below), but above it only counts up to +3% (deep-overbought
// territory above the 240-day average isn't a "sweet spot").
